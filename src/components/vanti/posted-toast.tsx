...
export function PostedToast({ id, onView }: PostedToastProps) {
  return (
    <div
      role="status"
      aria-live="polite"
      className="pointer-events-auto flex w-full justify-center px-4"
    >
      <div className="flex w-max max-w-[min(340px,calc(100vw-32px))] items-center gap-3 rounded-[12px] border border-[rgba(255,255,255,0.10)] bg-[#1C1C1F] px-4 py-3 shadow-[0_8px_24px_rgba(0,0,0,0.6)]">
        <Check
